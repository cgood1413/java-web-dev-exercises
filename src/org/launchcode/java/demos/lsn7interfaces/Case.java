...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Peanuts", 0.50, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping2 = new Topping("Chocolate sauce", 0.75, new ArrayList<>(Arrays.asList("dairy", "chocolate")));
        Topping topping3 = new Topping("Reece's Pieces", 1, new ArrayList<>(Arrays.asList("nuts", "dairy", "chocolate")));
